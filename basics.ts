...
let arr3: [number, string] = [12, "harsh"]; // already set that it has two types - defining types in ts

//array of specific type
let arr4: string[] = ["piyush", "month"];
...
if (typeof r === "string") r.toUpperCase(); // now we specify so it will work
